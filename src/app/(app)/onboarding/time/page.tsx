...
const times = [
    { id: "10", icon: Zap, title: "10 min", label: "Casual Learner", color: "from-blue-500/20 to-cyan-500/20", text: "text-blue-400" },
    { id: "20", icon: Flame, title: "20 min", label: "Steady Progress", color: "from-orange-500/20 to-red-500/20", text: "text-orange-400" },
    { id: "30", icon: Dumbbell, title: "30 min", label: "Serious Trainee", color: "from-purple-500/20 to-fuchsia-500/20", text: "text-purple-400" },
