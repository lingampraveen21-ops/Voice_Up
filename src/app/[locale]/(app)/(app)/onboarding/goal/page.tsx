...
export default function GoalSelectionPage() {
    ...
    const goals = [
        { id: "interview", icon: Briefcase, title: t("goalJob"), color: "from-blue-500/20 to-cyan-500/20", text: "text-blue-400" },
        { id: "academic", icon: GraduationCap, title: t("goalAcademic"), color: "from-purple-500/20 to-fuchsia-500/20", text: "text-purple-400" },
        { id: "everyday", icon: MessageCircle, title: t("goalEveryday"), color: "from-emerald-500/20 to-teal-500/20", text: "text-emerald-400" },
        { id: "advanced", icon: Rocket, title: t("goalAdvanced"), color: "from-rose-500/20 to-orange-500/20", text: "text-rose-400" },
    ]
