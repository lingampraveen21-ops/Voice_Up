...
export const BadgesRow: FC = () => {
    ...
    const badges = [
        { id: 1, icon: Flame, title: "3 Day Streak", earned: true, color: "text-orange-500", bg: "bg-orange-500/20 border-orange-500/30" },
        { id: 2, icon: Zap, title: "Fast Learner", earned: true, color: "text-amber-400", bg: "bg-amber-400/20 border-amber-400/30" },
        { id: 3, icon: Shield, title: "Perfect Score", earned: true, color: "text-emerald-400", bg: "bg-emerald-400/20 border-emerald-400/30" },
        { id: 4, icon: Star, title: "1000 XP", earned: false, color: "text-zinc-600", bg: "bg-white/5 border-white/10" },
        { id: 5, icon: Trophy, title: "Placement Pro", earned: false, color: "text-zinc-600", bg: "bg-white/5 border-white/10" },
    ]
    ...
    return (
        ...
        >
            <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-bold font-heading text-white">Recent Badges</h3>
