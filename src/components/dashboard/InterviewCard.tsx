            ...
            {hasDate ? (
                <>
                    <div className="flex justify-between items-start z-10 w-full mb-4">
                        <div>
                            <p className="text-zinc-400 font-medium text-sm mb-1 uppercase tracking-wider">Next Interview</p>
                    ...
                    <div className="z-10 flex items-center gap-4 mt-auto p-3 rounded-2xl bg-white/5 border border-white/5">
                        ...
                        <div>
                            <p className="text-sm font-bold text-white leading-tight">Readiness Score</p>
                            <p className="text-xs text-zinc-400 mt-1">Based on recent tests</p>
                        </div>
                    </div>
                </>
            ) : (
                <div className="flex flex-col items-center justify-center h-full text-center z-10 p-4">
                    ...
                    <p className="text-sm text-zinc-400 mb-4">No upcoming interview configured.</p>
                    <button className="text-sm font-semibold text-primary inline-flex items-center gap-2 group-hover:text-primary-light transition-colors">
                        Set Interview Date <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
                    </button>
                </div>
            )}
